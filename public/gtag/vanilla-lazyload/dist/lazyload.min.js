...
!(function (e, t) {
  ...
  function t(e, t, n) {
    (!n && i(e)) ||
      (L(t.callback_enter, e),
      I.indexOf(e.tagName) > -1 && (x(e, t), w(e, t.class_loading)),
      y(e, t),
      s(e),
      L(t.callback_set, e));
  }
  var n = function (e) {
    ...
    _ = d && "IntersectionObserver" in window,
    v = d && "classList" in document.createElement("p"),
    m =
      d &&
      (function () {
    ...
    h = function (e, t, n, o) {
      for (var s, i = 0; (s = e.children[i]); i += 1)
        if ("SOURCE" === s.tagName) {
          var a = r(s, n);
          b(s, t, a, o);
        }
    ...
    g = {
      IMG: function (e, t) {
        var n = m && t.to_webp,
          o = t.data_srcset,
          s = e.parentNode;
        s && "PICTURE" === s.tagName && h(s, "srcset", o, n);
        var i = r(e, t.data_sizes);
        b(e, "sizes", i);
        var a = r(e, o);
        b(e, "srcset", a, n);
    ...
    A = function (e, t, n) {
      var r = e.target;
      E(r, n.class_loading),
        w(r, t ? n.class_loaded : n.class_error),
        L(t ? n.callback_load : n.callback_error, r);
    },
    z = function (e, n, r) {
      t(e, r), n.unobserve(e);
    },
  ...
  return (
    (S.prototype = {
      ...
      update: function (t) {
        ...
        (this._elements = e(Array.prototype.slice.call(o))),
          !f && this._observer
            ? this._elements.forEach(function (e) {
      ...
      destroy: function () {
        var t = this;
        this._observer &&
          (e(this._elements).forEach(function (e) {
